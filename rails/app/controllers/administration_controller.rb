...
class AdministrationController < ApplicationController
  ...
  def send_test_alert
    id = 33
    system("rm -rf don_audio_#{id}.mp3")

    file_path_audio = "money_soundfx"
    donate = Donate.new(id: id, nickname: "DevCurumin",
                        message: "da nada, o que eu vejo de gente transmitindo the big bang/dois homens e meio aqui na twitch",
                        value: 1023.45)
  ...
  def gen_audio_donate(sound_fx, msg_donate, id)
    system("rm -rf public/don_audio_#{id}.mp3")
    system("rm -rf public/tts_donate/donate_*_aux.mp3")
    ...
    system("rm -rf public/tts_donate/#{msg_donate}.mp3")
    system("rm -rf public/tts_donate/#{msg_donate}_aux.mp3")
