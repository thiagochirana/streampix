...
/**
   * @returns {boolean}
   */var ce=function allButtonsAreHidden(){return!le(O())&&!le(j())&&!le(L())};
/**
   * @param {HTMLElement} elem
   * @returns {boolean}
...
/**
   * @param {SweetAlert} instance
   * @param {SweetAlertOptions} params
   */var Ee=function renderContainer(e,t){var n=C();if(n){handleBackdropParam(n,t.backdrop);handlePositionParam(n,t.position);handleGrowParam(n,t.grow);Y(n,t,"container")}};
/**
...
/**
   ...
   */function handleGrowParam(e,t){t&&Q(e,s["grow-".concat(t)])}var _e={innerParams:new WeakMap,domCache:new WeakMap};
/** @type {InputClass[]} */var Ie=["input","file","range","select","radio","checkbox","textarea"];
/**
   * @param {SweetAlert} instance
   * @param {SweetAlertOptions} params
   */var Oe=function renderInput(e,t){var n=A();if(n){var a=_e.innerParams.get(e);var r=!a||t.input!==a.input;Ie.forEach((function(e){var a=te(n,s[e]);if(a){Me(e,t.inputAttributes);a.className=s[e];r&&re(a)}}));if(t.input){r&&Le(t);He(t)}}};
/**
   * @param {SweetAlertOptions} params
...
/**
   * @param {SweetAlert} instance
   * @param {SweetAlertOptions} params
   */var Fe=function renderContent(e,t){var n=S();if(n){oe(n);Y(n,t,"htmlContainer");if(t.html){xe(t.html,n);ae(n,"block")}else if(t.text){n.textContent=t.text;ae(n,"block")}else re(n);Oe(e,t)}};
/**
   * @param {SweetAlert} instance
   * @param {SweetAlertOptions} params
...
/**
   * @param {SweetAlert} instance
   * @param {SweetAlertOptions} params
   */var Je=function renderImage(e,t){var n=E();if(n)if(t.imageUrl){ae(n,"");n.setAttribute("src",t.imageUrl);n.setAttribute("alt",t.imageAlt||"");ne(n,"width",t.imageWidth);ne(n,"height",t.imageHeight);n.className=s.image;Y(n,t,"image")}else re(n)};
/**
   * @param {SweetAlert} instance
   * @param {SweetAlertOptions} params
   */var Qe=function renderPopup(e,t){var n=C();var a=A();if(n&&a){if(t.toast){ne(n,"width",t.width);a.style.width="100%";var r=H();r&&a.insertBefore(r,P())}else ne(a,"width",t.width);ne(a,"padding",t.padding);t.color&&(a.style.color=t.color);t.background&&(a.style.background=t.background);re(I());et(a,t)}};
/**
   * @param {HTMLElement} popup
   * @param {SweetAlertOptions} params
...
/**
   * @param {SweetAlert} instance
   * @param {SweetAlertOptions} params
   */var ot=function render(e,t){Qe(e,t);Ee(e,t);tt(e,t);We(e,t);Je(e,t);rt(e,t);Se(e,t);Fe(e,t);Te(e,t);Ne(e,t);var n=A();typeof t.didRender==="function"&&n&&t.didRender(n)};var it=function isVisible(){return le(A())};var st=function clickConfirm(){var e;return(e=O())===null||e===void 0?void 0:e.click()};var lt=function clickDeny(){var e;return(e=j())===null||e===void 0?void 0:e.click()};var ct=function clickCancel(){var e;return(e=L())===null||e===void 0?void 0:e.click()};
...
/**
   * @param {string} key
   */var bt=function handleArrows(e){var t=V();var n=O();var a=j();var r=L();if(t&&n&&a&&r){
/** @type HTMLElement[] */
...
/**
   * @param {TouchEvent} event
   * @returns {boolean}
   */var Tt=function shouldPreventTouchMove(e){var t=e.target;var n=C();var a=S();return!(!n||!a)&&(!St(e)&&!Et(e)&&(t===n||!ue(n)&&t instanceof HTMLElement&&t.tagName!=="INPUT"&&t.tagName!=="TEXTAREA"&&(!ue(a)||!a.contains(t))))};
/**
...
/**
   ...
   * @param {TouchEvent} event
   * @returns {boolean}
   */var Et=function isZoom(e){return e.touches&&e.touches.length>1};var _t=function undoIOSfix(){if(K(document.body,s.iosfix)){var e=parseInt(document.body.style.top,10);ee(document.body,s.iosfix);document.body.style.top="";document.body.scrollTop=e*-1}};
/**
...
/**
   ...
   */var Lt=function replaceScrollbarWithPadding(e){if(Ot===null&&(document.body.scrollHeight>window.innerHeight||e==="scroll")){Ot=parseInt(window.getComputedStyle(document.body).getPropertyValue("padding-right"));document.body.style.paddingRight="".concat(Ot+It(),"px")}};var jt=function undoReplaceScrollbarWithPadding(){if(Ot!==null){document.body.style.paddingRight="".concat(Ot,"px");Ot=null}};
/**
   * @param {SweetAlert} instance
   * @param {HTMLElement} container
   * @param {boolean} returnFocus
   * @param {Function} didClose
   */function removePopupAndResetState(e,t,a,o){if(W())Rt(e,o);else{r(a).then((function(){return Rt(e,o)}));dt(n)}if(At){t.setAttribute("style","display:none !important");t.removeAttribute("class");t.innerHTML=""}else t.remove();if(N()){jt();_t();xt()}removeBodyClasses()}function removeBodyClasses(){ee([document.documentElement,document.body],[s.shown,s["height-auto"],s["no-backdrop"],s["toast-shown"]])}
/**
   * Instance method to close sweetAlert
   *
   * @param {any} resolveValue
   */function close(t){t=Vt(t);var n=Ct.swalPromiseResolve.get(this||e);var a=Mt(this||e);if((this||e).isAwaitingPromise){if(!t.isDismissed){Ht(this||e);n(t)}}else a&&n(t)}var Mt=function triggerClosePopup(e){var t=A();if(!t)return false;var n=_e.innerParams.get(e);if(!n||K(t,n.hideClass.popup))return false;ee(t,n.showClass.popup);Q(t,n.hideClass.popup);var a=C();ee(a,n.showClass.backdrop);Q(a,n.hideClass.backdrop);Dt(e,t,n);return true};
/**
   * @param {any} error
   */function rejectPromise(t){var n=Ct.swalPromiseReject.get(this||e);Ht(this||e);n&&n(t)}
/**
   * @param {SweetAlert} instance
   */var Ht=function handleAwaitingPromise(e){if(e.isAwaitingPromise){delete e.isAwaitingPromise;_e.innerParams.get(e)||e._destroy()}};
/**
   * @param {any} resolveValue
...
/**
   * @param {HTMLElement} popup
   * @param {HTMLButtonElement | null} [buttonToReplace]
   */var Ft=function replaceButton(e,t){var n=V();var a=H();if(n&&a){!t&&le(O())&&(t=O());ae(n);if(t){re(t);a.setAttribute("data-button-to-replace",t.className);n.insertBefore(a,t)}Q([e,n],s.loading)}};
/**
   * @param {SweetAlert} instance
   * @param {SweetAlertOptions} params
   */var Nt=function handleInputOptionsAndValue(e,t){if(t.input==="select"||t.input==="radio")Zt(e,t);else if(["text","email","number","tel","textarea"].some((function(e){return e===t.input}))&&(g(t.inputValue)||y(t.inputValue))){qt(O());Yt(e,t)}};
/**
   * @param {SweetAlert} instance
   * @param {SweetAlertOptions} innerParams
...
/**
     ...
     */
var a=function processInputOptions(e){t.input==="select"?populateSelectOptions(n,Xt(e),t):t.input==="radio"&&populateRadioOptions(n,Xt(e),t)};if(g(t.inputOptions)||y(t.inputOptions)){qt(O());b(t.inputOptions).then((function(t){e.hideLoading();a(t)}))}else _typeof(t.inputOptions)==="object"?a(t.inputOptions):w("Unexpected type of inputOptions! Expected object, Map or Promise, got ".concat(_typeof(t.inputOptions)))}};
/**
   * @param {SweetAlert} instance
   * @param {SweetAlertOptions} params
...
/**
   * @param {SweetAlert} instance
   */var Qt=function handleConfirmButtonClick(e){var t=_e.innerParams.get(e);e.disableButtons();t.input?nn(e,"confirm"):ln(e,true)};
/**
   * @param {SweetAlert} instance
   */var en=function handleDenyButtonClick(e){var t=_e.innerParams.get(e);e.disableButtons();t.returnInputValueOnDeny?nn(e,"deny"):rn(e,false)};
/**
   * @param {SweetAlert} instance
   * @param {Function} dismissWith
...
/**
   ...
   * @param {SweetAlert} instance
   * @param {any} value
   */var ln=function confirm(e,t){var n=_e.innerParams.get(e||Jt);n.showLoaderOnConfirm&&qt();if(n.preConfirm){e.resetValidationMessage();e.isAwaitingPromise=true;var a=Promise.resolve().then((function(){return b(n.preConfirm(t,n.validationMessage))}));a.then((function(n){if(le(I())||n===false){e.hideLoading();Ht(e)}else on(e,typeof n==="undefined"?t:n)})).catch((function(t){return sn(e||Jt,t)}))}else on(e,t)};function hideLoading(){var t=_e.innerParams.get(this||e);if(t){var n=_e.domCache.get(this||e);re(n.loader);W()?t.icon&&ae(P()):cn(n);ee([n.popup,n.actions],s.loading);n.popup.removeAttribute("aria-busy");n.popup.removeAttribute("data-loading");n.confirmButton.disabled=false;n.denyButton.disabled=false;n.cancelButton.disabled=false}}var cn=function showRelatedButton(e){var t=e.popup.getElementsByClassName(e.loader.getAttribute("data-button-to-replace"));t.length?ae(t[0],"inline-block"):ce()&&re(e.actions)};
/**
   * Gets the input DOM node, this method works with input parameter.
   *
   * @returns {HTMLInputElement | null}
   */function getInput(){var t=_e.innerParams.get(this||e);var n=_e.domCache.get(this||e);return n?X(n.popup,t.input):null}
/**
   * @param {SweetAlert} instance
   * @param {string[]} buttons
   * @param {boolean} disabled
   */function setButtonsDisabled(e,t,n){var a=_e.domCache.get(e);t.forEach((function(e){a[e].disabled=n}))}
/**
...
/**
   * @param {SweetAlert} instance
   */var xn=function disposeWeakMaps(e){if(e.isAwaitingPromise){An(_e,e);e.isAwaitingPromise=true}else{An(Ct,e);An(_e,e);delete e.isAwaitingPromise;delete e.disableButtons;delete e.enableButtons;delete e.getInput;delete e.disableInput;delete e.enableInput;delete e.hideLoading;delete e.disableLoading;delete e.showValidationMessage;delete e.resetValidationMessage;delete e.close;delete e.closePopup;delete e.closeModal;delete e.closeToast;delete e.rejectPromise;delete e.update;delete e._destroy}};
/**
   * @param {object} obj
   * @param {SweetAlert} instance
...
/**
   ...
   * @param {Function} dismissWith
   */var Bn=function handlePopupClick(e,t,n){if(e.toast)Tn(e,t,n);else{_n(t);In(t);On(e,t,n)}};
/**
   * @param {SweetAlertOptions} innerParams
   * @param {DomCache} domCache
   * @param {Function} dismissWith
...
/**
   * @param {SweetAlertOptions} innerParams
   * @returns {boolean}
   */var Sn=function isAnyButtonShown(e){return!!(e.showConfirmButton||e.showDenyButton||e.showCancelButton||e.showCloseButton)};var En=false;
/**
   * @param {DomCache} domCache
   */var _n=function handleModalMousedown(e){e.popup.onmousedown=function(){e.container.onmouseup=function(t){e.container.onmouseup=function(){};t.target===e.container&&(En=true)}}};
/**
   * @param {DomCache} domCache
   */var In=function handleContainerMousedown(e){e.container.onmousedown=function(t){t.target===e.container&&t.preventDefault();e.popup.onmouseup=function(t){e.popup.onmouseup=function(){};(t.target===e.popup||t.target instanceof HTMLElement&&e.popup.contains(t.target))&&(En=true)}}};
/**
   * @param {SweetAlertOptions} innerParams
   * @param {DomCache} domCache
   * @param {Function} dismissWith
   */var On=function handleModalClick(e,t,n){t.container.onclick=function(a){En?En=false:a.target===t.container&&v(e.allowOutsideClick)&&n(ut.backdrop)}};var Ln=function isJqueryElement(e){return _typeof(e)==="object"&&e.jquery};var jn=function isElement(e){return e instanceof Element||Ln(e)};var Mn=function argsToParams(e){var t={};_typeof(e[0])!=="object"||jn(e[0])?["title","html","icon"].forEach((function(n,a){var r=e[a];typeof r==="string"||jn(r)?t[n]=r:r!==void 0&&w("Unexpected type of ".concat(n,'! Expected "string" or "Element", got ').concat(_typeof(r)))})):Object.assign(t,e[0]);return t};
/**
...
/** @type {HTMLElement | null} */var n=e.querySelector("swal-image");if(n){aa(n,["src","width","height","alt"]);n.hasAttribute("src")&&(t.imageUrl=n.getAttribute("src")||void 0);n.hasAttribute("width")&&(t.imageWidth=n.getAttribute("width")||void 0);n.hasAttribute("height")&&(t.imageHeight=n.getAttribute("height")||void 0);n.hasAttribute("alt")&&(t.imageAlt=n.getAttribute("alt")||void 0)}return t};
/**
   * @param {DocumentFragment} templateContent
   * @returns {SweetAlertOptions}
...
/**
   * @param {SweetAlert} instance
   * @returns {DomCache}
   */var ha=function populateDomCache(e){var t={popup:A(),container:C(),actions:V(),confirmButton:O(),denyButton:j(),cancelButton:L(),loader:H(),closeButton:R(),validationMessage:I(),progressSteps:_()};_e.domCache.set(e,t);return t};
/**
   * @param {GlobalState} globalState
   * @param {SweetAlertOptions} innerParams
   * @param {Function} dismissWith
